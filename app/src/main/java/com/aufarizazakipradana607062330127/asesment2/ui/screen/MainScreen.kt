...
import com.aufarizazakipradana607062330127.asesment2.navigation.Screen
        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.tambah_produk),
                    tint = MaterialTheme.colorScheme.primary
                )
            }
        }
...
@Composable
fun ListItem(kelolaProduk: KelolaProduk, onClick: () -> Unit) {
    Column (
...
@Composable
fun GridItem(kelolaProduk: KelolaProduk, onClick: () -> Unit) {
    Card(
